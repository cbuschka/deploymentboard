...
class LocalCommandEndpointHandlerTest
{
	@InjectMocks
	private LocalCommandEndpointHandler handler;
	...
	{
		givenEndpointWithoutUrlAndWithoutCommand();
	...
	private void givenEndpointWithoutUrlAndWithoutCommand()
	{
		when(this.endpoint.getUrl()).thenReturn(null);
		when(this.endpoint.getCommand()).thenReturn(null);
	}
