...
@Component
public class SimpleGitChangeCollector implements GitChangeCollector
{
	private GitCommitCollector gitCommitCollector;

	public SimpleGitChangeCollector(GitCommitCollector gitCommitCollector)
	{
		this.gitCommitCollector = gitCommitCollector;
	}

	@Override
	public boolean handles(ChangeDetectionAlgorithm algorithm)
	{
		return algorithm == ChangeDetectionAlgorithm.simple;
	}
